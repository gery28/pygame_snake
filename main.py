    ...
    while not game_over:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP and can_move_y:
                    snake_y_change = -snake_block
                    snake_x_change = 0
                    can_move_y=False
                    can_move_x=True
                if event.key == pygame.K_DOWN and can_move_y:
                    snake_y_change = snake_block
                    snake_x_change = 0
                    can_move_y=False
                    can_move_x=True
                if event.key == pygame.K_LEFT and can_move_x:
                    snake_x_change = -snake_block
                    snake_y_change = 0
                    can_move_x=False
                    can_move_y=True
                if event.key == pygame.K_RIGHT and can_move_x:
                    snake_x_change = snake_block
                    snake_y_change = 0
                    can_move_x=False
                    can_move_y=True
